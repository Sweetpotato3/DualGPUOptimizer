...
os.environ["PYTORCH_ENABLE_OBSOLETE_CUDA_COMPAT"] = "1"  # Enable compatibility with newer CUDA architectures
...
def check_and_install_torch():
    ...
    try:
        ...
        try:
            ...
            cuda_version = "cu121" if int(py_version[0]) == 3 and int(py_version[1]) >= 12 else "cu122"
            ...
            subprocess.check_call([
                ...
                f"torch=={torch_version}", f"torchvision=={vision_version}", f"torchaudio=={audio_version}",
