...
from dualgpuopt.services.telemetry import TelemetryWorker, GPUMetrics
...
class TestGPUTelemetryIntegration:
    ...
    def test_telemetry_with_changing_gpu_state(self, signal_recorder):
        ...
        side_effect_values = [initial_gpu_data, initial_gpu_data, changed_gpu_data, changed_gpu_data]
