...
from dualgpuopt.engine.pool import EnginePool, _LRUPool, _port_open, _ping_backend
...
class TestEnginePool(unittest.TestCase):
    ...
    @patch('dualgpuopt.engine.pool._executor')
    @patch('dualgpuopt.engine.pool.Engine')
    def test_unhealthy_engine_reload(self, mock_engine_class, mock_executor, mock_ping, mock_event_bus):
