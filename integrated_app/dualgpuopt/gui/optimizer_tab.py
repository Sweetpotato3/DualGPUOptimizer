...
class OptimizerTab(ttk.Frame):
    ...
    def _context_changed(self) -> None:
        ...
        try:
            ...
            if ctx_size > 0:
                app_state.set("context_size", ctx_size)
                self._refresh_outputs()
    ...
    def _refresh_outputs(self, _=None) -> None:
        ...
        try:
            ...
            if model_path:
                cmd_results = generate_commands(self.gpus, model_path, ctx)
                self.llama_var.set(cmd_results["llama_cpp"])
    ...
    def _save_env(self) -> None:
        ...
        try:
            ...
            self.logger.error(f"Error saving env file: {e}")
