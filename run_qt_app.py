...
def main():
    ...
    try:
        ...
        try:
            ...
            logger.error(
                "PySide6 is not installed. Please install it with: pip install PySide6==6.5.2"
            )
            print(
                "Error: PySide6 is not installed. Please install it with: pip install PySide6==6.5.2"
            )
            return 1
