...
from dualgpuopt.gui.launcher import (
    config_handler,
    launch_controller,
    model_validation,
    parameter_resolver,
...
class TestLaunchController(unittest.TestCase):
    ...
    def setUp(self):
        ...
        self.patcher = patch(
            "dualgpuopt.gui.launcher.launch_controller.ProcessMonitor",
            return_value=self.mock_process_monitor,
        )
        self.patcher.start()
        ...
        self.resolver_patcher = patch(
            "dualgpuopt.gui.launcher.launch_controller.ParameterResolver",
            return_value=self.mock_parameter_resolver,
        )
