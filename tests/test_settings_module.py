...
from dualgpuopt.gui.settings import appearance, application_settings, overclocking
...
class TestAppearanceSettings(unittest.TestCase):
    ...
    def setUp(self):
        ...
        self.patcher = patch(
            "dualgpuopt.gui.settings.appearance.SETTINGS_FILE", self.temp_file.name
        )
        self.patcher.start()
...
class TestOverclockingSettings(unittest.TestCase):
    ...
    def setUp(self):
        ...
        # Mock the settings file path
        self.patcher = patch(
            "dualgpuopt.gui.settings.overclocking.SETTINGS_FILE", self.temp_file.name
        )
        self.patcher.start()
    ...
    def test_load_settings(self):
        ...
        # Should match the sample settings
        self.assertEqual(
            settings["gpu_0"]["core_clock_offset"],
            self.sample_settings["gpu_0"]["core_clock_offset"],
        )
        self.assertEqual(
            settings["gpu_1"]["memory_clock_offset"],
            self.sample_settings["gpu_1"]["memory_clock_offset"],
        )
    ...
    def test_save_settings(self):
        ...
        # Should match the new settings
        self.assertEqual(
            loaded_settings["gpu_0"]["core_clock_offset"],
            new_settings["gpu_0"]["core_clock_offset"],
        )
        self.assertEqual(
            loaded_settings["gpu_1"]["memory_clock_offset"],
            new_settings["gpu_1"]["memory_clock_offset"],
        )
...
class TestApplicationSettings(unittest.TestCase):
    ...
    def setUp(self):
        ...
        # Mock the settings file path
        self.patcher = patch(
            "dualgpuopt.gui.settings.application_settings.SETTINGS_FILE", self.temp_file.name
        )
        self.patcher.start()
