...
from dualgpuopt.serve.legal_api import api_tokens, app
...
def test_auth_and_rate_limit(monkeypatch):
    ...
    r1 = client.post("/api/chat", headers=headers, json={"prompt": "bonjour", "use_rag": False})
    ...
    r2 = client.post("/api/chat", headers=headers, json={"prompt": "encore", "use_rag": False})
