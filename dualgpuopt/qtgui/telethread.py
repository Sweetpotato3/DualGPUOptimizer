...
if not hasattr(telemetry_module, 'GPUMetrics'):
    ...
    telemetry_path = os.path.join(os.path.dirname(os.path.dirname(os.path.abspath(__file__))), 'telemetry.py')
...
class TeleWorker(QObject):
    ...
    def _check_alerts(self, gpu_id: int, metrics: GPUMetrics):
        ...
        # CRITICAL alerts
        elif metrics.memory_percent >= 90 or metrics.temperature >= 80 or metrics.power_percent >= 98:
        ...
        # WARNING alerts
        elif metrics.memory_percent >= 75 or metrics.temperature >= 70 or metrics.power_percent >= 90:
