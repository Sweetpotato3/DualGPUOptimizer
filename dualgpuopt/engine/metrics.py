...
def update_model_metrics(model_name: str, backend: str, tokens_per_second: float, 
    ...
    try:
        ...
        MODEL_TOKENS_PER_SECOND.labels(model_name=model_short_name, backend=backend).set(tokens_per_second)
