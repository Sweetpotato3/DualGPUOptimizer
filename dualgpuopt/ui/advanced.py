...
class MemoryTimelineWidget(QtW.QWidget):
    ...
    def paintEvent(self, event):
        ...
        # Draw grid
        self._draw_grid(painter, self.margin, self.margin, 
                        plot_width, plot_height)
        
        # Draw data if we have any
        if self.history:
            self._draw_data(painter, self.margin, self.margin, 
                          plot_width, plot_height)
            
        # Draw axes
        self._draw_axes(painter, self.margin, self.margin, 
                       plot_width, plot_height)
...
class AdvancedDock(QtW.QDockWidget):
    ...
    def _export_png(self):
        ...
        file_path, _ = QtW.QFileDialog.getSaveFileName(
            self, "Save PNG", "memory_timeline.png", "PNG Files (*.png)"
        )
