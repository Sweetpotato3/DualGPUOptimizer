...
from dualgpuopt.gui.theme.colors import AVAILABLE_THEMES, current_theme, update_current_theme
...
def toggle_theme(root):
    ...
    if (
        current_theme == AVAILABLE_THEMES["dark_purple"]
        or current_theme == AVAILABLE_THEMES["neon_dark"]
    ):
        theme_name = "light"
    else:
